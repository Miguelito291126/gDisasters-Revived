...
function ENT:Initialize()		
	...
	if (SERVER) then
		...
		gDisasters_Revived.GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(2,5),["Direction"]=Vector(math.random(-1,1),math.random(-1,1),0)}, ["Pressure"]    = 97000, ["Temperature"] = math.random(-5,0), ["Humidity"]    = math.random(20,45), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
