...
function ENT:Initialize()	
	...
	if (SERVER) then
		...
		if IsMapRegistered() == true then
			self.Child = createFlood(math.random(GetConVar("gdisasters_revived_envdynamicwater_level_min"):GetInt(),GetConVar("gdisasters_revived_envdynamicwater_level_max"):GetInt()), self)
		else
			self:Remove()
