...
function ENT:Initialize()		
	...
	if (SERVER) then
		...
		gDisasters_Revived.GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(24,27),["Direction"]=Vector(-1,0,0)}, ["Pressure"]    = 95000, ["Temperature"] = math.random(10,15), ["Humidity"]    = math.random(85,92), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
