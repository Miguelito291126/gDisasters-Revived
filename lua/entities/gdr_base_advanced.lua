...
function ENT:Explode()
	...
	if GetConVar("gdisasters_revived_sound_speed"):GetInt() == 0 then
		ent:SetVar("SHOCKWAVE_INCREMENT",200)
	elseif GetConVar("gdisasters_revived_sound_speed"):GetInt()== 1 then
		ent:SetVar("SHOCKWAVE_INCREMENT",300)
	elseif GetConVar("gdisasters_revived_sound_speed"):GetInt() == 2 then
...
function ENT:OnTakeDamage(dmginfo)
	 ...
	 if(GetConVar("gdisasters_revived_fragility"):GetInt() >= 1) then
...
function ENT:Use( activator, caller )
     if(self.Exploded) then return end
     if(self:IsValid()) then
	     if(GetConVar("gdisasters_revived_easyuse"):GetInt() >= 1) then
