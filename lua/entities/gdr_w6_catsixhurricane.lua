...
function ENT:Initialize()		
	...
	if (SERVER) then
		...
		gDisasters_Revived.GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(300,355),["Direction"]=Vector(math.random(-1,1),math.random(-1,1),0)}, ["Pressure"]    = 95000, ["Temperature"] = math.random(10,15), ["Humidity"]    = math.random(40,85), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
