...
function ENT:Initialize()		
	...
	if (SERVER) then
		...
		gDisasters_Revived.GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(65,78),["Direction"]=Vector(-1,0,0)}, ["Pressure"]    = 95000, ["Temperature"] = math.random(9,11), ["Humidity"]    = math.random(75,90), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
...
function ENT:OnRemove()
	...
	if (SERVER) then		
		...
		for k, v in pairs(ents.FindByClass("gdr_d4_severethunderstorm_cl")) do v:Remove() end
...
function ENT:Lightning()
	...
	if !self:IsValid() then return end
		local ent = ents.Create("gdr_d4_severethunderstorm_cl")
		ent:SetPos(pos)
		ent:Spawn()
		ent:Activate()
