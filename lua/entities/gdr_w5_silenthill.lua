	...
	if fogtype != self.LastFogType then 
		...
		if fogtype == true then -- darkness
			...
			timer.Simple(1, function()
				...
				LocalPlayer().gDisasters_Revived.Fog.Data.Color = Color(25,25,25)
				LocalPlayer().gDisasters_Revived.Fog.Data.DensityCurrent = 0
				LocalPlayer().gDisasters_Revived.Fog.Data.DensityMax     = 5000
				LocalPlayer().gDisasters_Revived.Fog.Data.DensityMin     = 5000
				LocalPlayer().gDisasters_Revived.Fog.Data.EndMax         = 100
				LocalPlayer().gDisasters_Revived.Fog.Data.EndMin         = 0.9
				LocalPlayer().gDisasters_Revived.Fog.Data.EndMinCurrent  = 0
				LocalPlayer().gDisasters_Revived.Fog.Data.EndMaxCurrent  = 0       
			...
			timer.Simple(1, function()
				...
				LocalPlayer().gDisasters_Revived.Fog.Data.Color = Color(255,255,255)
				LocalPlayer().gDisasters_Revived.Fog.Data.DensityCurrent = 0
				LocalPlayer().gDisasters_Revived.Fog.Data.DensityMax     = 5000
				LocalPlayer().gDisasters_Revived.Fog.Data.DensityMin     = 5000
				LocalPlayer().gDisasters_Revived.Fog.Data.EndMax         = 100
				LocalPlayer().gDisasters_Revived.Fog.Data.EndMin         = 0.97
				LocalPlayer().gDisasters_Revived.Fog.Data.EndMinCurrent  = 0
				LocalPlayer().gDisasters_Revived.Fog.Data.EndMaxCurrent  = 0       
...
function ENT:CreateEnemies()
	...
	if math.random(1,1000)==1000 then
		...
		for k, v in pairs(player.GetAll()) do
			...
			if tr.Hit then 
				local nurse = ents.Create("gdr_dnpc_nurse")
