...
function ENT:Initialize()	
	...
	if (SERVER) then
		...
		local data = { 
					StartHeight  = GetConVar("gdisasters_revived_envdynamicwater_b_startlevel"):GetInt(),
					StartWedge   = self.StartWedgeConstant,
					
					MiddleHeight = GetConVar("gdisasters_revived_envdynamicwater_b_middellevel"):GetInt(),
