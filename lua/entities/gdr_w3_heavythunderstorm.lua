...
function ENT:Initialize()		
	...
	if (SERVER) then
		...
		gDisasters_Revived.GLOBAL_SYSTEM_TARGET =  {["Atmosphere"] 	= {["Wind"]        = {["Speed"]=math.random(32,39),["Direction"]=Vector(-1,0,0)}, ["Pressure"]    = 95000, ["Temperature"] = math.random(15,18), ["Humidity"]    = math.random(40,80), ["BRadiation"]  = 0.1, ["Oxygen"]  = 100}}
...
function ENT:OnRemove()
	...
	if (SERVER) then		
		...
		for k, v in pairs(ents.FindByClass("gdr_d3_heavythunderstorm_cl")) do v:Remove() end
