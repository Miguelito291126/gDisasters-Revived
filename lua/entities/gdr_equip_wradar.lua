...
cloud_intensity_to_weather_ent = {
	...
	["gdr_env_tornado"] = 0.5,
	["gdr_dw1_sandstorm"] = 0.8,
	["gdr_dw1_duststorm"] = 1,
	["gdr_dw1_lightrain"] = 0.25,
	["gdr_dw1_heavyfog"] = 0.3,
	["gdr_dw1_catonehurricane"] = 0.4,
	["gdr_dw1_tropicaldepression"] = 0.5,
	["gdr_dw1_tropicalstorm"] = 0.5,
	["gdr_dw1_highpressure_sys"] = 0,
	["gdr_dw1_snow"] = 0.6,
	["gdr_dw1_sunny"] = 0,
	["gdr_dw1_night"] = 0,
	["gdr_dw1_shootingstarshower"] = 0,
	["gdr_dw1_sleet"] = 0.5,
	["gdr_dw1_smog"] = 0.4, 
	["gdr_dw1_cumu_cldy"] = 0.25, 
	["gdr_dw1_tropicalstorm"] = 0, 
	["gdr_dw2_heavysnow"] = 0.5, 
	["gdr_dw2_acidrain"] = 0.5, 
	["gdr_dw2_modbreeze"] = 0,
	["gdr_dw2_heavyrain"] = 0.7,
	["gdr_dw2_cattwohurricane"] = 0.6,
	["gdr_dw2_heatwave"] = 0.2,
	["gdr_dw2_haboob"] = 1,
	["gdr_dw2_freezingrain"] = 0.5,
	["gdr_dw2_stationaryfront"] = 0.8,
	["gdr_dw2_hailstorm"] = 0.8,
	["gdr_dw2_smog"] = 0.2,
	["gdr_dw2_chinese_smog"] = 0.4,
	["gdr_dw2_lowpressure_sys"] = 0.2,
	["gdr_dw2_coldwave"] = 0.1,
	["gdr_dw2_thunderstorm"] = 0.9,
	["gdr_dw2_thundersnow"] = 0.9,
	["gdr_dw2_shelfcloud"] = 1,
	["gdr_dw3_extremeheavyrain"] = 0.8,
	["gdr_dw3_extremerain"] = 0.5,
	["gdr_dw3_cattheehurricane"] = 0.7,
	["gdr_dw3_blizzard"] = 0.8,
	["gdr_dw3_icestorm"] = 0.8, 
	["gdr_dw3_heatburst"] = 1,
	["gdr_dw3_major_hailstorm"] = 0.9,
	["gdr_dw3_strongbreeze"] = 0,
	["gdr_dw3_drought"] = 0,
	["gdr_dw3_coldfront"] = 0.5,
	["gdr_dw3_drythunderstorm"] = 0.9,
	["gdr_dw3_hurricanic_lowpressure_sys"] = 0.8,
	["gdr_dw3_heavyashstorm"] = 0.5, 
	["gdr_dw3_warmfront"] = 0.5,
	["gdr_dw3_occludedfront"] = 0.6,
	["gdr_dw3_heavythunderstorm"] = 1,
	["gdr_dw4_intensebreeze"] = 0,
	["gdr_dw4_catfourhurricane"] = 0.8,
	["gdr_dw4_heavyacidrain"] = 0.8,
	["gdr_dw4_severethunderstorm"] = 1,
	["gdr_dw4_strong_occludedfront"] = 1,
	["gdr_dw4_dryline"] = 0.5,
	["gdr_dw4_strong_coldfront"] = 1,
	["gdr_dw4_strong_warmfront"] = 0.8,
	["gdr_dw4_derecho"] = 1,
	["gdr_dw4_growingstorm"] = 1,
	["gdr_dw5_catfivehurricane"] = 0.9,
	["gdr_dw5_silenthill"] = 0.2,
	["gdr_dw5_pyrocum"] = 0.8,
	["gdr_dw5_macroburst"] = 1,
	["gdr_dw5_microburst"] = 1,
	["gdr_dw5_downburst"] = 1,
	["gdr_dw7_freezeray"] = 1, 
	["gdr_dw6_catsixhurricane"] = 1,
	["gdr_dw7_hypercane"] = 1,
	["gdr_dw7_martiansnow"] = 1,
	["gdr_dw7_redspot"] = 1, 
	["gdr_dw7_neptune"] = 1,
	["gdr_dw7_martianduststorm"] = 1,
	["gdr_dw7_solarray"] = 0,
	["gdr_d1_aurora"] = 0,
	["gdr_d1_cldy_irid"] = 0.5,
	["gdr_d1_cumcloud"] = 0.8,
	["gdr_d6_cryoshower"] = 1,
...
function ENT:ShouldNotRender()	
	return not(self:IsThisShitOn()) or (self:GetPos():Distance(LocalPlayer():GetPos()) >= GetConVar("gdisasters_revived_graphics_dr_maxrenderdistance"):GetInt())
end
...
function ENT:Initialize()	
	...
	if (CLIENT) then 
		...
		self.ScreenMaterial        = Material("models/gdr_dweather_radar")
...
function ENT:AddGlobalClouds() 
	...
	local function ReturnIntensity()
		local i = 0
		local t1, t2 = ents.FindByClass("gdr_d*"), ents.FindByClass("env_*")
...
function ENT:UpdateDisplay()
	...
	self.NextDisplayUpdateTime = CurTime() + ((1 / GetConVar("gdisasters_revived_graphics_dr_updaterate"):GetFloat() ) or 1)
	...
	local function UpdateForTornado()
		local targets = ents.FindByClass("gdr_env_tornado")
...
function gDisasters_Revived.RenderRadarPixels(self)
	...
	if (CurTime() >= self.NextDisplayRefreshTime)  then 
		...
		self.NextDisplayRefreshTime = self.NextDisplayRefreshTime + ((1 / GetConVar("gdisasters_revived_graphics_dr_refreshrate"):GetFloat() ) or 1)
		
		local monochromatic_mode = GetConVar("gdisasters_revived_graphics_dr_monochromatic"):GetString()=="true"
		...
		--local alpha = math.Clamp(self:GetPos():Distance(LocalPlayer():GetPos()) / GetConVar("gdisasters_revived_graphics_dr_maxrenderdistance"):GetInt(),0, GetConVar("gdisasters_revived_graphics_dr_maxrenderdistance"):GetInt()) ^ 0.5  setblend doesn't work
...
hook.Add("PostDrawOpaqueRenderables", "gdr_dequip_wradar.draw.pixelscreen",function() 
	...
	for k, v in pairs(radars) do 
		...
		if dist_to_player <= max_render_distance then 
			...
			gDisasters_Revived.RenderRadarPixels(v)
		end
...
function FetchConVarResolution()
	local cords = string.Explode("x",GetConVar("gdisasters_revived_graphics_dr_resolution"):GetString() or "16x16")
