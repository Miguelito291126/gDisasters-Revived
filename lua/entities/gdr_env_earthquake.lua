...
function ENT:CreateEarthquakeWithParent()
	local earthquakes = {}
	earthquakes[1] = "gdr_d1_rs1eq"
	earthquakes[2] = "gdr_d2_rs2eq"
	earthquakes[3] = "gdr_d3_rs3eq"
	earthquakes[4] = "gdr_d4_rs4eq"
	earthquakes[5] = "gdr_d5_rs5eq"
	earthquakes[6] = "gdr_d6_rs6eq"
	earthquakes[7] = "gdr_d7_rs7eq"
	earthquakes[8] = "gdr_d8_rs8eq"
	earthquakes[9] = "gdr_d9_rs9eq"
	earthquakes[10] = "gdr_d10_rs10eq"
	earthquakes[11] = "gdr_d11_rs11eq"
	earthquakes[12] = "gdr_d12_rs12eq"
...
function createEarthquake(magnitude, parent)
	...
	local earthquake = ents.Create("gdr_env_earthquake")
...
function ENT:Unfreeze(phys, v, mag)
	...
	if math.random(1,512 - math.floor((25.6*self.Magnitude)))==1 and v:GetClass()!="worldspawn" then
		...
		phys:Wake()
		constraint.RemoveAll( v )
		if GetConVar("gdisasters_revived_envearthquake_change_collision_group"):GetInt() >= 1 then 
