...
local function gDisastersSHSettings( CPanel )
	...
	CreateTickboxConVariable(CPanel, "gdr_d6" ,"gdisasters_tvirus_zombie_strength");
	CreateTickboxConVariable(CPanel, "gdr_d7" ,"gdisasters_tvirus_nmrih_zombies");
end
...
local function gDisastersSHADVSettings( CPanel )
	...
	CreateSliderConVariable(CPanel, "gdr_d12", 0.1, 0.50, 2, "gdisasters_envearthquake_simquality" );
	...
	CreateTickboxConVariable(CPanel, "gdr_d22" ,"gdisasters_envearthquake_change_collision_group");
	...
	CreateTickboxConVariable(CPanel, "gdr_d28" ,"gdisasters_weather_bradiation_damage_props");
	CreateTickboxConVariable(CPanel, "gdr_d28.1" ,"gdisasters_weather_bradiation_damage_npcs");
...
local function gDisastersSHGraphics( CPanel )
	...
	CreateSliderConVariable(CPanel,"gdr_d48", 0, 1000, 0,"gdisasters_antilag_maximum_safe_collisions_per_second_per_prop");
	CreateSliderConVariable(CPanel,"gdr_d49", 0, 1000, 0,"gdisasters_antilag_post_damage_no_collide_base_time");
	CreateSliderConVariable(CPanel,"gdr_d50", 0, 1000, 0,"gdisasters_antilag_maximum_safe_collisions_per_second_average" );

	local lb4 = AddControlLabel( CPanel, "gdr_d51" )
	lb4:SetTextColor(Color( 0, 0, 0))
	lb4:SetSize(500, 500)
	
	CreateSliderConVariable(CPanel,"gdr_d52", 0, 2, 0,"gdisasters_antilag_mode" );
	CreateTickboxConVariable(CPanel,"gdr_d53", "gdisasters_antilag_enabled" );
...
local function gDisastersHeatSystemBeta( CPanel )
	...
	CreateTickboxConVariable(CPanel, "gdr_d88", "gdisasters_heat_system_enabled");
...
local function gDisastersAddonsCompatibility( CPanel )
	...
	CreateTickboxConVariable(CPanel, "gdr_d84"  , "gdisasters_spacebuild_enabled");

	local lb = AddControlLabel( CPanel, "gdr_d85" )
	lb:SetTextColor(Color( 0, 0, 0))
	lb:SetSize(500, 500)
	
	CreateTickboxConVariable(CPanel, "gdr_d86"  , "gdisasters_stormfox_enabled");
end
